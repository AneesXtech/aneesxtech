...
/// reveal section code start///
  // Select all big sections you want animated
  const revealSections = document.querySelectorAll(
    ".approach-section, .services-section, .accordion-progress-wrapper, .root-container-xyz"
  );

  // Add hidden state
  revealSections.forEach(sec => sec.classList.add("reveal-blur"));
